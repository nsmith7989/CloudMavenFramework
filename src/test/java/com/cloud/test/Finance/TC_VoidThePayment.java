...
public class TC_VoidThePayment extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void Cloud_Void_The_Payment(String UserName,String Password,String PartyName,String PaymentNumber)throws TestException,InterruptedException, TestException {
