...
public class TC_PostInvoiceAsAccountInDraft extends BaseWebTest  {
SoftAssert sAssert;
...
@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to Post Invoice as Account in Draft")
	...
	public void Cloud_Post_Inv_Account_Draft(String UserName,String Password,String BusinessUnit,String InvoiceNumber,String PartyName)throws TestException,InterruptedException, TestException {
