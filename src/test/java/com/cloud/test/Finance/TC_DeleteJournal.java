...
public class TC_DeleteJournal extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void Cloud_Delete_Journal(String UserName,String Password,String Journal,String JournalBatch,String AccountingPeriod)throws TestException,InterruptedException, TestException {
		...
		/*report.log(LogStatus.INFO, "Step 10. Select Accounting Period");
		objMngJournal.isAccountingPeriodDisplayed();
		objMngJournal.SelectAccountingPeriod(AccountingPeriod);
		...
		report.log(LogStatus.INFO, "Step 18. Click on Journals Action menu");
		objeditJournal.isJournalActionMenuDisplayed();
		objeditJournal.clickJournalActionMenu();
		
		report.log(LogStatus.INFO, "Step 19. Click on Delete option from Journals Action menu");
		objeditJournal.isJournalDeleteListDisplayed();
		objeditJournal.clickJournalDeleteList();
		
		report.log(LogStatus.INFO, "Step 20. Click on Delete Confirmation Yes button");
		...
		report.log(LogStatus.INFO, "Step 22. Click on Save and Close option from Save Menu");
